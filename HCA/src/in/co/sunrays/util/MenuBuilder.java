...
public class MenuBuilder {
	...
	public static String getMenu(long roleId, int i) {
		...
		if (roleId == AppRole.DOCTOR || roleId == AppRole.ADMIN) {
			...
			map.put("Add Doctor", ORSView.DOCTOR_CTL);
			map.put("Doctor List", ORSView.DOCTOR_LIST_CTL);
			map.put("Add Patient", ORSView.PATIENT_CTL);
			map.put("Patient List", ORSView.PATIENT_LIST_CTL);
			map.put("Add Appointment", ORSView.APPOINTMENT_CTL);
			map.put("Appointment List", ORSView.APPOINTMENT_LIST_CTL);
			map.put("Chat", ORSView.CHAT_CTL);
			map.put("Add Chat", ORSView.CHAT_LIST_CTL);
			map.put("Add Request", ORSView.REQUESTMASTER_CTL);
			map.put("List Request", ORSView.REQUESTMASTER_LIST_CTL);

		} else if (roleId == AppRole.PATIENT) {
			map.put("Add Appointment", ORSView.APPOINTMENT_CTL);
			map.put("Chat", ORSView.CHAT_CTL);
			map.put("Change Password", ORSView.CHANGE_PASSWORD_CTL);
			map.put("MyProfile", ORSView.MY_PROFILE_CTL);
